...
The `movehat run` command provides your script with access to the **Movehat Runtime Environment (MRE)**, which includes the Aptos SDK client, account management, contract helpers, and more.
